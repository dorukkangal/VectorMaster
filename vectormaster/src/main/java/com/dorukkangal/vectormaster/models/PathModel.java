...
import com.dorukkangal.vectormaster.DefaultValues;
import com.dorukkangal.vectormaster.utilities.Utils;
import com.dorukkangal.vectormaster.utilities.parser.PathParser;
...
public class PathModel {
    ...
    public void buildPath(boolean useLegacyParser) {
        if (useLegacyParser) {
            originalPath = com.dorukkangal.vectormaster.utilities.legacyparser.PathParser.createPathFromPathData(pathData);
        } else {
